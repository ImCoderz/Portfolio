    ...
    <div className='flex justify-center items-center mt-10 transition-all duration-100 bounce'>
        <div className='bare_gradient w-[60vw] h-fit flex p-5 justify-between md:flex-row flex-col'>
            ...
            <div className='cursor-pointer self-center z-10'>
                <button  className=' bg-black rounded-xl text-white font-thin lg:text-sm text-[12px] px-6 py-1 w-full md:w-auto cursor-pointer hover:scale-110'>Show All</button>
            </div>
        </div>
    </div>
  )

...
const Homepage = () => {
    ...
    return (
        <div className='sm:px-28 px-0 md:px-12 md:mt-20 mt-1 grid md:grid-cols-2 grid-col-1 md:gap-6 gap-20 place-items-center'>
            ...
            <div className=' grid relative place-items-center ml-12 animate-slideright transition-shadow duration-100'>
                <div className={`lg:w-[70px] w-[55px] lg:h-[70px] h-[55px] rounded-full bg-purple2color absolute lg:-right-4 lg:-top-10 -right-4 -top-8  spin`}>
                    <img className='object-cover pictureblur flex justify-center items-center rounded-full w-full h-full' src={List[0]} alt="" />
                </div>
                <div className={`lg:w-[70px] w-[55px] lg:h-[70px] h-[55px] rounded-full bg-purple2color absolute lg:right-32 lg:-top-20 right-32 -top-16  spin`}>
                    <img className='object-cover pictureblur flex justify-center items-center rounded-full w-full h-full' src={List[1]} alt="" />
                </div>
                <div className={`lg:w-[70px] w-[55px] lg:h-[70px] h-[55px] rounded-full bg-purple2color absolute lg:-left-12 lg:-top-4 -left-8 -top-0  spin`}>
                ...
                <div className={`lg:w-[70px] w-[55px] lg:h-[70px] h-[55px] rounded-full bg-purple2color absolute lg:-left-24 lg:top-32 -left-16 top-32  spin`}>
                    <img className='object-cover pictureblur flex justify-center items-center rounded-full w-full h-full' src={List[3]} alt="" />
                </div>
                <div className={`lg:w-[70px] w-[55px] lg:h-[70px] h-[55px] rounded-full bg-purple2color absolute lg:-left-8 lg:-bottom-8 -left-4 -bottom-4  spin`}>
                    <img className='object-cover pictureblur flex justify-center items-center rounded-full w-full h-full' src={List[4]} alt="" />
                </div>
                <div className={`lg:w-[70px] w-[55px] lg:h-[70px] h-[55px] rounded-full bg-purple2color absolute lg:right-20 lg:-bottom-20 right-24 -bottom-16  spin`}>

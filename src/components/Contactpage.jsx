...
const Contactpage = () => {
  return (
    <div className='flex flex-col gap-6 md:px-40 px-10 mt-20 relative overflow-hidden '>
        ...
        <form action="submit" className='flex flex-col items-center sm:items-start  gap-4 '>
            <div className='overflow-x-hidden flex gap-4 md:justify-start justify-start items-center md:w-[40vw]  w-[350px]  h-[10vh] bg-purple2color p-2 px-4 animate-slideright'>
            ...
            <div className='overflow-x-hidden flex gap-4 items-center md:w-[40vw] w-[350px]  h-[10vh] bg-purple2color sm:ml-[30vw] p-2 px-4 animate-slideleft'> 
            ...
            <div className='overflow-x-hidden flex gap-4 items-center md:w-[40vw] w-[350px]  h-[10vh] bg-purple2color p-2 px-4 animate-slideright'>
            ...
            <div className='overflow-x-hidden flex flex-col gap-4 items-center md:w-[40vw] w-[350px]  h-[48vh] bg-blue1color p-2 px-4 sm:ml-36 relative animate-slidedown'>
